...
import picture from '../assets/Indira.jpeg'
...
function About() {
 ...
 <hr/>
                              ...
                              <div className='row mt-3'>
                                <div className='col-sm-3 mt-2' style={{ 'textAlign': 'center' }}>
                                  <img src="https://cdn-icons-png.flaticon.com/512/1079/1079003.png" style={{width:'55px',height:'55px'}}/>
                                  {/* <span className="bi bi-mortarboard-fill blue-color" style={{ 'fontSize': '50px' }}> </span> */}
                                </div>
                                <div className='col-sm-6'>
                                  <div className='mx-1'>
                                    <p></p>
                                    <h5 style={{ 'fontFamily': 'serif', 'textAlign': 'center' }}>MERN Full Stack Development</h5>
